# Self-hosting Sentinel OSS

Sentinel OSS is designed to be run by your own team.
...
4. Set `SENTINEL_SCAN_MODE=fast` for low overhead, or `deep` when you want richer inspection.
