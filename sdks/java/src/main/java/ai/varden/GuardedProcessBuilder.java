...
public final class GuardedProcessBuilder {
    ...
    GuardedProcessBuilder(List<String> command, VardenClient client, VardenConfig config) {
    ...
    public static GuardedProcessBuilder of(VardenClient client, VardenConfig config, String... command) {
