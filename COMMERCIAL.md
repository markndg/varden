...
- Core platform, control plane, policy engine, dashboard, and frontend source: AGPL-3.0-or-later
- SDKs in `sdks/python`, `sdks/java`, and `sdks/rust`: Apache License 2.0
...
- closed-source use of the core platform
- SaaS / managed-service rights
- OEM / redistribution rights
- support and SLAs
- bespoke integration or deployment rights
